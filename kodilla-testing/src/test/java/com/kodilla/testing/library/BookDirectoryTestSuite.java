...
class BookDirectoryTestSuite {
    ...
    void testListBooksInHandsOf() {                          // [1]
        ...
        LibraryUser libraryUser0 = new LibraryUser("L", "U", "0");
        LibraryUser libraryUser1 = new LibraryUser("L", "U", "1");
        LibraryUser libraryUser5 = new LibraryUser("L", "U", "5");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser0))
                .thenReturn(listOfBooks0);
        ...
        List<Book> resultListOfBooks5 = bookLibrary.listBooksInHandsOf(libraryUser5);
